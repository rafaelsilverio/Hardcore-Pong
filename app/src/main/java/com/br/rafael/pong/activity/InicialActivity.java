...
public class InicialActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Se o aparelho no tiver suporte a BT, sinaliza e bloqueia botao de multiplayer
        if(adaptadorBT == null){
        	
        	//Avisa ao usurio o problema
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
	        ...
	        case ACTIVITY_REQUISITA_LIGAR_BT:
	            ...
	            //Caso o usurio tenha habilitado o bt normalmente
	            ...
	            //Caso o BT no foi habilitado corretamente
	            else {
