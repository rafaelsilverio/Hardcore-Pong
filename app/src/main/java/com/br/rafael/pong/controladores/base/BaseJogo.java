...
public class BaseJogo {
	...
	//Mantem flag que define se a fase deve ser finalizada, e a prxima ser chamada
	...
	//Declara as propores dos elementos
	...
	//Declara os valores brutos, aps calculo de proporcao com o tamanho da tela do celular
	...
	public void desenha(Canvas canvas, Paint paint){
		...
		//Se h elementos avulsos, percorre desenhando
	...
	/**
	 * Checa se a bola bate em alguma deadzone, realizando as aes necessrias
	 */
	...
	/**
	 * Checa se a bola bate em alguma parede limitadora, realizando as aes necessrias
	 */
	...
	/**
	 * Em caso de coliso prvia, remaneja as posicoes da bola
	 */
	...
	/**
	 * Em caso de coliso prvia com as laterais, remaneja as posicoes da bola
	 */
	...
	public void checagemColisaoElemento(Retangulo comparador, Bola bolaRemanejada){
		...
		if(comparador.verificaColisao(bolaInicial)){
			...
			if(distanciaCentro != 0){
				...
				//Recebe o resto com a diferena da velocidade
	...
	public void atualizaBolaInicial(){
		...
		//Inicia uma instancia de bola, que vai receber o remanejamento da bola principal, para suavizar a animao de bater nas extremidades de elementos
		...
		//Ao mover a bola, pode ocorrer uma o em que a bola entra no elemento, sua posicao deve ser remanejada nesse caso
	...
	//Realiza logica de inclinao da bola, quando ocorre colisao com players
	...
	/**
	 * Define o que fazer quando o usurio tocar no modal, deve ser
	...
	/**
	 * Verificaes padronizadas para fim de jogo, utilizada para jogos com 2 players
	 */
