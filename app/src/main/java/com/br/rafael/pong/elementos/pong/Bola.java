...
public class Bola extends Circulo {
	...
	private float aceleradorMovimento; //Determina a que passo a velocidade da bola  aumentada
	...
	/**
	 * Define osximos valores que devem ser alocados nos atributos da classe.
	 * O mtodo o faz verificaes de es, que devem ser realizadas externamente.
	 */
	...
	public void aumentaVelocidade(){
		...
		//Incrementa a velocidade apenas se no foi aumentada no mximo
		if(numeroMaximoAceleracoes > 0){
			velocidadeMovimento = velocidadeMovimento + aceleradorMovimento;
			numeroMaximoAceleracoes--;
			
			//Reduz a colorao verde (ficando cada vez mais vermelho)
			reduzColoracao();
		}
	}
	 ...
	 * Caso chamada duas vezes, a 2a chamada no faz nada.
	 */
