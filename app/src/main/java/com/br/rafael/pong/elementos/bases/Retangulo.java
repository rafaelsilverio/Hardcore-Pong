 ...
 * Um retangulo  determinado por um X e Y, que representam
 * o vrtice superior esquerdo, e uma altura e largura.
 * 
 * @author Rafael
 *
 */
public class Retangulo extends Elemento{
	 ...
	 * 
	 * @param X posio (X) do vrtice superior superior a direita
	 * @param Y posio (Y) do vrtice superior superior a direita
	...
	public boolean verificaColisao(Retangulo retangulo){
		...
		//Colisao  caracterizada quando  colisao tanto em X quanto em Y
	...
	public boolean verificaColisao(Circulo circulo){
		...
		if(colisaoX && colisaoY){
			...
			//Define ponto que deve ser utilizado para calcular coliso nos vertices do retangulo
		...
		//Retorna que no houve colisao
		return false;
	}	
	
	/**
	 * Retorna o ponto mdio da coordenada Y, na posical atual do retangulo
	 */
