...
/**
 * Representa os elementos mais bsicos de uma tela grfica,
 * conhecendo atributos bsicos, tais como posio X e Y.
 * 
 * @author Rafael
 *
 */
public class Elemento {
	...
	//Mantem um atributo que define se o elemento se encontra ou o ativo
	...
	/**
	 * Mtodo que deve ser implementado por todos que extendem elemento
	 */
